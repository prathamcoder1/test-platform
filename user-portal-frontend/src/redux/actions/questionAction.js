...
export const getAllQusetions = () => {
  return async(dispatch)=> {
    const response = await axios.get(apis.BASE + apis.GET_ALL_QUESTIONS,{
      headers:{
    ...
    if(response.data.success) {
      dispatch({
        ...
        payload : {
          ...
          title : "Success",
          type : "success",
          message : response.data.allQuestions
        }
      })

      return response.data.allQuestions;
    }
    else {
      dispatch({
        type:ActionTypes.SET_ALERT,
